...
# Do not change code above this line. Use the PSQL variable above to query your database.
 ...
 cat games.csv | while IFS="," read -r YEAR ROUND WINNER OPPONENT WINNERGOALS OPPONENTGOALS
    do
      if [[ $YEAR != "year" ]]
        then
            # get winner_id
            ...
            then
                echo -e "Inserted into games, $YEAR : $ROUND : $WINNER : $OPPONENT : $WINNERGOALS : $OPPONENTGOALS\n"
            fi
        fi
    done 